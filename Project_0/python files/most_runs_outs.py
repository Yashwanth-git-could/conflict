...
# URL to scrape
url = 'https://www.cricket.com/series/indian-premier-league-2024-4554/stats/t20-fielding-most-run-outs'
...
df.to_sql('most_runs_outs', con=engine, index=False, if_exists='replace')
