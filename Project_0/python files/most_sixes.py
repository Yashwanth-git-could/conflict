...
# URL to scrape
url = 'https://www.cricket.com/series/indian-premier-league-2024-4554/stats/t20-batting-most-6s'
...
df.to_sql('most_sixes', con=engine, index=False, if_exists='replace')
