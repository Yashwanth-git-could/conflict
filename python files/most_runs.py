...
# URL to scrape
url = 'https://www.cricket.com/series/indian-premier-league-2024-4554/stats/t20-batting-most-runs'
...
df.to_sql('most_runs', con=engine, index=False, if_exists='replace')
