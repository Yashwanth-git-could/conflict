...
# URL to scrape
url = 'https://www.cricket.com/series/indian-premier-league-2024-4554/stats/t20-bowling-most-wickets'
...
df.to_sql('most_wickets', con=engine, index=False, if_exists='replace')
