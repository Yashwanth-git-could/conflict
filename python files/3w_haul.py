...
# URL to scrape
url = 'https://www.cricket.com/series/indian-premier-league-2024-4554/stats/t20-bowling-three-wicket-haul'
...
df.to_sql('3w_haul', con=engine, index=False, if_exists='replace')
